...
clip.addIncident(moveTop("-8px",".slide6 .title .letter",400,"@stagger(0,700)"),33000)
...
clip.addIncident(moveTop("0px",".slide9 .word",400,"@stagger(0,400)"),49200)
...
clip.addIncident(moveTop("0px",".slide9 .letter",200,"@stagger(0,400)"),51000)
clip.addIncident(moveTop("0px",".slide9 .job",300),51000)
clip.addIncident(heightMove("100%",".slide9 .person-line",300),51000)
clip.addIncident(moveTop("-100px",".slide9 .letter",200,"@stagger(0,200)"),55000)
...
clip.addIncident(heightMove("70%",".slide12 .text-wrapper",400),76000)
clip.addIncident(heightMove("30%",".slide12 .content",400),76000)
clip.addIncident(moveTop("-8px",".slide12 .title .letter",400,"@stagger(0,700)"),76500)
clip.addIncident(opacity1(".slide12 .box .letter",100,"@stagger(0, 600)"),76800)
...
clip.addIncident(moveTop("-10px",".slide12 .text",300),81000)
clip.addIncident(moveTop("-180px",".slide12 .text",300),85000)
clip.addIncident(moveLeft("-100%",".slide12 .location",300),83000)
clip.addIncident(widthMove("0%",".slide12 .line",400),82900)
clip.addIncident(widthMove("250px",".slide12 .img",300),83500)
clip.addIncident(heightMove("250px",".slide12 .img",300),83500)