export const initParams = [
  {
    ...
    value: {
      ...
      slide1: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/man-and-woman-talk.mp4?raw=true",
        location: {
          city: "NewYork",
          country: "USA",
        },
      ...
      slide2: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/world-news.mp4",
        location: {
          city: "Moscow",
          country: "RUSSIA",
        },
      ...
      slide3: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/man-talk.mp4",
        text: [
          "The",
          "idea",
          "of",
      ...
      slide4: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/woman-talk.mp4",
      ...
      slide5: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/demonstration.mp4",
        ...
        personImg:
          "https://github.com/donkeyclip/news-clip/blob/main/demo/assets/person.jpeg?raw=true",
      },
      slide6: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/live.mp4",
      ...
      slide7: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/breaking-news.mp4",
        title: "breaking news",
        text: "fake news is cheap to produce genuine journalism is expensive nothing in fine print is ever good news.",
      },
      slide8: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/police.mp4",
      ...
      slide9: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/woman-in-red.mp4",
        title: ["BREAKING", "NEWS"],
        text: {
      ...
      slide10: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/france-news.mp4",
        text1:
          "The news used to be to report facts and allow you to make the decision.",
        text2:
          "This country is a better place because Cube News has succeeded.",
        location: {
          city: "Paris",
          country: "France",
        },
      ...
      slide11: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/france-news2.mp4",
      ...
      slide12: {
        video:
          "https://donkey-spaces.ams3.cdn.digitaloceanspaces.com/assets/news-clip/people.mp4",
        ...
        person: {
          personImg:
            "https://github.com/donkeyclip/news-clip/blob/main/demo/assets/woman.jpeg?raw=true",
          name: "Emma Wilson",
          job: "reporter",
        },
      },
